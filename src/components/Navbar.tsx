...
export function Navbar({ setAddress }: NavbarProps) {
  ...
  return (
    <>
      <nav
        className=" w-full flex justify-between p-3 top-0 sticky bg-white shadow-xl"
        style={{ height: "70px" }}
      >
        ...
        <div className={"flex flex-row"}>
          {address ? (
            <>
              ...
              <button
                className={
                  "hidden md:flex btn btn-danger rounded-xl p-2 px-5 bg-red-700 hover:bg-red-900 text-white shadow border"
                }
