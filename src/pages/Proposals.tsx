    ...
    <>
      ...
      <div className="p-10">
        <div className="container mx-auto">
          <h1 className="text-6xl font-bold mb-5">Proposals</h1>
          {address ? (
            <div className="flex flex-row gap-5">
              <div className="md:w-3/4 flex flex-col">
                {proposals.length > 0 ? (
                  proposals
                    ...
                    .map((proposal: any) => {
                      return (
                        <div className="bg-white flex flex-col rounded-xl shadow-xl mb-5">
                          <div
                            key={proposal.id}
              ...
              <div className="md:w-1/4 flex flex-col">
                <div className="p-3 bg-white flex flex-col rounded-xl shadow-xl">
